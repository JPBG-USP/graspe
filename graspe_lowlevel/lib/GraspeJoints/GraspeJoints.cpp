 ...
 */
GraspeJoints::GraspeJoints(const int& input_pin, const std::map<std::string,float>& input_limits,int input_offset, const float& input_initial,const float& input_modifier){
